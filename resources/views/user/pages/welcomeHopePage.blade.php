...
@section('content')
    ...
    @if ($toasterValue == 1)
        <script>
            toastr.success('Please register to Start course...');
        </script>
        @php
    ...
    <div class="hero-wrap js-fullheight"
        ...
        <div class="container">
            <div class="row no-gutters slider-text js-fullheight align-items-center" data-scrollax-parent="true">
                ...
                <div class="col-md-5 ftco-animate  p-3 mb-5 bg-white rounded">
                    ...
                    <p class="mb-0">
                        ...
                        @if (isset($user) && !empty($user))
                            @if ($user->role != null)
                            @else
                                <a href="{{ route('trainer.register.page') }}"><button
                                        class="btnLoginTrainer font-weight-bold">
                                        {{ __('lang.trainer') }}
                                    </button></a>
                                <a href="{{ route('trainee.register.page') }}"><button
                                        class="btnLoginTrainee  font-weight-bold">
                                        {{ __('lang.trainee') }}</button></a>
                            @endif
                        @else
                            <a href="{{ route('trainer.register.page') }}" class="btnLogin">
                                {{ __('lang.trainer') }}</a>
                            <a href="{{ route('trainee.register.page') }}" class="btn btn-white">
                                {{ __('lang.trainee') }}</a>
                        @endif
    ...
    <section class="ftco-section services-section" id=offer>
        <div class="container">
            <div class="row d-flex">
